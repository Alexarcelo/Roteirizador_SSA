...
def inserir_df_rotas_geradas(aba_excel, df_insercao):
    ...
    spreadsheet = client.open_by_key('1O3HQ-q8sUyDfrSaWemazyN-2eNMZq6UIn0Id-XCd7Ds')
    sheet = spreadsheet.worksheet(aba_excel)
...
def salvar_rotas_historico(df_pdf):
    ...
    puxar_historico('1O3HQ-q8sUyDfrSaWemazyN-2eNMZq6UIn0Id-XCd7Ds', ['Histórico Roteiros'], ['df_historico_roteiros'])
